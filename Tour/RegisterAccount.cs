...
namespace Tour
{
    public partial class RegisterAccount : Form
    {
        ...
        /*string connectionString = @"Data Source=ADMIN;Initial Catalog=TourManagement;Integrated Security=True";*/
        string connectionString = DataConnection.Ins.conStr;
